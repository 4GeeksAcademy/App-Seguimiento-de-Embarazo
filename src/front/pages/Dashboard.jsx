...
export const Dashboard = () => {
    ...
    // ESTADO RESTAURADO AL 100% (No falta ningún campo)
    ...
    const handleGuardarDia = async (e) => {
        ...
        try {
            ...
            if (response.ok) { fetchDashboardData(); alert("¡Registro guardado con éxito! ✨"); }
    ...
    if (!data) return <div className="p-5 text-center">No se pudo cargar la información del servidor.</div>;
    ...
    if (mostrarIdeal) {
        chartDatasets.push({ label: "Peso Recomendado", data: data.chart_config?.ideal_data || [], borderColor: "#10b981", borderDash: [6, 4], fill: false, tension: 0.4, pointRadius: 0 });
    }
    ...
    return (
        <div className="container-fluid min-vh-100 py-5 dashboard-container">
            ...
            <div className="container" style={{ maxWidth: "1100px" }}>
                ...
                {/* INFO SEMANA Y PROGRESO (DINÁMICO) */}
                    ...
                    <div className="row justify-content-center">
                        <div className="col-md-10">
                            ...
                            <div className="d-flex justify-content-center gap-4 mb-2">
                                ...
                                <span className="fs-5 text-muted"><i className="fas fa-ruler-vertical me-2"></i>Aprox: <strong>{data.bebe?.cm || '0'} cm</strong></span>
                            </div>
                ...
                <div className="row g-4">
                    <div className="col-lg-8">
                        ...
                        <div className="glass-card p-4 mb-4">
                            ...
                            <div style={{ height: "300px" }}>
                                <Line key={mostrarIdeal} data={{ labels: data.chart_config?.labels || [], datasets: chartDatasets }} options={{ responsive: true, maintainAspectRatio: false, plugins: { legend: { display: false } } }} />
                            </div>
                        </div>

                        {/* REGISTRO DIARIO (FORMULARIO COMPLETO) */}
                                    ...
                                    <div className="col-12">
                                        ...
                                        <div className="d-flex flex-wrap gap-2">
                                            {Object.keys(registro.sintomas).map((s) => (
                                                <button 
                                                    key={s} type="button" 
                                                    className={`btn-sintoma ${registro.sintomas[s] ? 'active' : ''}`}
                                                    onClick={() => setRegistro({...registro, sintomas: {...registro.sintomas, [s]: !registro.sintomas[s]}})}>
                    ...
                    <div className="col-lg-4">
                        ...
                        {/* BOTÓN PDF */}
                        <button onClick={descargarPDF} className="btn btn-white glass-card w-100 py-3 mb-4 fw-bold text-danger border-0">
                            <i className="fas fa-file-medical me-2"></i> Descargar Historial Médico
                        </button>

                        {/* MINI GRÁFICA SÍNTOMAS */}
